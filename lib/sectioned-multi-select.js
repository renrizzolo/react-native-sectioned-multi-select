...
class SectionedMultiSelect extends PureComponent {
  static propTypes = {
    ...
    // NM ADD
    selectedParentIconComponent: PropTypes.oneOfType([PropTypes.func, PropTypes.object]),
    unselectedParentIconComponent: PropTypes.oneOfType([PropTypes.func, PropTypes.object]),
    // NM ADD END
