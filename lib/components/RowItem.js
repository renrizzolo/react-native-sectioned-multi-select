...
class RowItem extends Component {
  ...
  _renderSelectedIcon = () => {
    const {
      item,
      selectedParentIconComponent, // NM
      mergedColors,
      unselectedParentIconComponent, // NM
      iconRenderer: Icon,
    } = this.props
    return this._itemSelected(item)
      ? callIfFunction(selectedParentIconComponent) || ( // NM
      <Icon
        name="check"
        style={{
              fontSize: 16,
      ...
      : callIfFunction(unselectedParentIconComponent) || null // NM
  }
